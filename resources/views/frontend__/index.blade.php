<x-app-layout>
    {{--<div class="wrap-home">
        <div class="container">
            ...
            <div class="wrap-title">
                <div class="row">
                    <div class="col text-center">
                        <h1 class="company-title">ខេ អេជ អឹម អឹម អូ</h1>
                        <h4 class="company-sub-title">សុវត្ថិភាពក្នុងការ ទិញ និង លក់អនឡាញដំបូងគេនៅកម្ពុជា</h4>
                    </div>
                </div>
            </div>
    ...
    @include('frontend__.productList')
</x-app-layout>
